  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (data.user.role === 'Parent') {
        ...
        Alert.alert('Access Denied', 'Only Parents are allowed to access this application');
        notifyAuthChange();
      }
    } catch (err: any) {
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        ...
        >
          ...
          <View className="mb-6">
            ...
            />
            {errors.email && (
              <Text className="text-xs text-red-500 mt-1.5 ml-1.5">{errors.email}</Text>
            )}
          </View>
          ...
          <View className="mb-2">
            ...
            {errors.password && (
              <Text className="text-xs text-red-500 mt-1.5 ml-1.5">{errors.password}</Text>
            )}
          </View>
          ...
          {/* Divider */}
          <View className="relative h-6 justify-center mb-7">
          ...
          {/* Auth Options */}
          <View className="mb-8">
            <Text className="text-center text-slate-600 text-sm">Auth Options Component</Text>
          </View>
